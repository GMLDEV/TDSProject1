...
# ------------------- Cohere Setup -------------------
co = cohere.Client("MpalnFM5a6YEeyTuLYnWeN63L3aWJvqb8jXm9wA9")  # Replace with your actual key or use env variable
...
"""
    ...
    try:
        response = co.chat(
            model="command-r-plus",  # or "command-r" for lighter usage
            message=prompt,
            temperature=0.3
        )
